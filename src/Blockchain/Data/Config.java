...
public class Config {
	...
	public static final String PUBLICKEY_FILE = "src/Blockchain/Data/PublicKey";
    public static final String PRIVATEKEY_FILE = "src/Blockchain/Data/PrivateKey";
    
    public static final String BC_OBJ_FILE = "src/Blockchain/Data/bc_obj.dat";
    public static final String BC_ORDER_FILE = "src/Blockchain/Data/bc_order.dat";
    public static final String BC_INVENTORY_FILE = "src/Blockchain/Data/bc_inventory.dat";
    public static final String BC_STOCK_FILE = "src/Blockchain/Data/bc_stock.dat";
    public static final String BC_FILE = "src/Blockchain/Data/bc.txt";
    public static final String LEDGER_ORDER_FILE = "src/Blockchain/Data/ledger_order.txt";
    public static final String LEDGER_INVENTORY_FILE = "src/Blockchain/Data/ledger_inventory.txt";
    public static final String LEDGER_STOCK_FILE = "src/Blockchain/Data/ledger_stock.txt";
